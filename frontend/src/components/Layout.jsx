...
const workflowSteps = [
  ...
  { key: "duplicates_ai", label: "Duplicados IA", path: "/editor", description: "Buscar coincidencias", actionTestId: "check-duplicates-ai-button", actionLabel: "Buscar duplicados IA" },
